...
module.exports = {
	...
	'6': {
		...
		standard: [],
		introduce: {
			title: '经助家认证的育儿嫂，依托专业辅导团队、不仅为用户提供婴幼儿日常料理，健康膳食、用品清洁等专业护理，还提供潜能开发，学前教育和行为培养等成长服务，选择专业育儿嫂，帮忙宝宝快乐成长。',
	...
	'7': {
		...
		process: imgUrl + 'process-ys.png',
		warn: ['1.上门试用满意后确定人选；', '2.第一天免费试用，超出时长，按约定日薪收取费用；', '3.未找到适用阿姨，订金将全额退款（若有试用工资未结算的将扣除）；'],
		assurance: [{
			t: '健康保障',
			c: '服务人员均通过健康认证，每年进行2次健康检查，保障雇主家庭健康安全！'
		}, {
